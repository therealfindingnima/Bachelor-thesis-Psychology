...
## Setting path, opening original data
...
## Data examination to get a general idea
...
## Removing valgevoel (not used for my paper)

BDATA <- BDATA %>%
  select(-contains("valgvoel"))

## Removing 'onbekend' (which seems to be NA but then labeled) 

### Columns not to touch
protected_cols <- c("idnr", "condition", "age", "gender", "lastmeas", "numbermeas")

BDATA_cleaned <- BDATA # New data set in case things go wrong
...
for (col_name in names(BDATA_cleaned)) {
  if (!(col_name %in% protected_cols) && is.factor(BDATA_cleaned[[col_name]])) {   # Only touch non-protected factor columns
    ...
    if (length(target) > 0) { # Remove the level and convert the data to NA without touching other levels
...
## Select data I need: protected columns + any column ending in 1.00, 2.00, or 5.00
...
## Removing irrelavant items to my study
...
## Exploring the parcels visually to assess continuousness
...
# START ANALYSIS HERE: USE BDATA_numeric.rds----
...
## Stripping ghost levels and keeping only 8 and 24 (will run into errors otherwise)
BDATA_numeric <- BDATA_numeric[BDATA_numeric$condition %in% c(8, 24), ]
BDATA_numeric$condition <- factor(BDATA_numeric$condition)

# Factor Analyses at each measurement occasion----
...
# Structural Equation Modeling (steps 1 and 2)----
...
LONG_MODEL_STEP2 = '
    ...
    Psych_1 =~ NA*c(L1_8, L1_24)*psych_1 + c(L2_8, L2_24)*social_1 + c(L3_8, L3_24)*vita_1
    Psych_2 =~ NA*c(L1_8, L1_24)*psych_2 + c(L2_8, L2_24)*social_2 + c(L3_8, L3_24)*vita_2
    Psych_5 =~ NA*c(L1_8, L1_24)*psych_5 + c(L2_8, L2_24)*social_5 + c(L3_8, L3_24)*vita_5

    Phys_1  =~ NA*c(L4_8, L4_24)*somatic_1 + c(L5_8, L5_24)*gast_1 + c(L6_8, L6_24)*musculo_1 + c(L7_8, L7_24)*cutane_1 + c(L8_8, L8_24)*vita_1
    Phys_2  =~ NA*c(L4_8, L4_24)*somatic_2 + c(L5_8, L5_24)*gast_2 + c(L6_8, L6_24)*musculo_2 + c(L7_8, L7_24)*cutane_2 + c(L8_8, L8_24)*vita_2
    Phys_5  =~ NA*c(L4_8, L4_24)*somatic_5 + c(L5_8, L5_24)*gast_5 + c(L6_8, L6_24)*musculo_5 + c(L7_8, L7_24)*cutane_5 + c(L8_8, L8_24)*vita_5
    
    Func_1  =~ NA*c(L9_8, L9_24)*bas_act_1 + c(L10_8, L10_24)*comp_act_1 + c(L11_8, L11_24)*social_1
    Func_2  =~ NA*c(L9_8, L9_24)*bas_act_2 + c(L10_8, L10_24)*comp_act_2 + c(L11_8, L11_24)*social_2
    Func_5  =~ NA*c(L9_8, L9_24)*bas_act_5 + c(L10_8, L10_24)*comp_act_5 + c(L11_8, L11_24)*social_5
    ...
    Psych_1 ~~ c(1, 1)*Psych_1
    Phys_1  ~~ c(1, 1)*Phys_1
    Func_1  ~~ c(1, 1)*Func_1

    Psych_2 ~~ c(NA, NA)*Psych_2
    Phys_2  ~~ c(NA, NA)*Phys_2
    Func_2  ~~ c(NA, NA)*Func_2

    Psych_5 ~~ c(NA, NA)*Psych_5
    Phys_5  ~~ c(NA, NA)*Phys_5
    Func_5  ~~ c(NA, NA)*Func_5
...
# Step 3: relaxing int musculo_5 (MF)----
...
# Step 3: relaxing int musculo_2 (MF)----
...
# Step 3: relaxing int musculo_5 (SF)----
...
# Step 3: relaxing int musculo_2 (SF)----
...
# Step 3: relaxing resvar gast_2 (SF)----
...
# Step 3: relaxing int psych_5 (MF)----
...
# Step 3: relaxing int somatic_2 (MF)----
...
# Step 3: relaxing int cutane_2 (MF)----
...
# Step 3: relaxing factload comp_act_5 on Func_5 (SF)----
...
LONG_MODEL_STEP2.10 = '
    ...
    Func_1  =~ NA*c(L9_8, L9_24)*bas_act_1 + c(L10_8, L10_24)*comp_act_1 + c(L11_8, L11_24)*social_1
    Func_2  =~ NA*c(L9_8, L9_24)*bas_act_2 + c(L10_8, L10_24)*comp_act_2 + c(L11_8, L11_24)*social_2
    Func_5  =~ NA*c(L9_8, L9_24)*bas_act_5 + c(L10_8_T5, L10_24)*comp_act_5 + c(L11_8, L11_24)*social_5     #freed
...
# Step 3: relaxing resvar musculo_5 (SF)----
...
LONG_MODEL_STEP2.11 = '
    ...
    vita_1 ~~ c(E8_3, E24_3)*vita_1;          vita_2 ~~ c(E8_3, E24_3)*vita_2;          vita_5 ~~ c(E8_3, E24_3)*vita_5
    somatic_1 ~~ c(E8_4, E24_4)*somatic_1;    somatic_2 ~~ c(E8_4, E24_4)*somatic_2;    somatic_5 ~~ c(E8_4, E24_4)*somatic_5
    gast_1 ~~ c(E8_5, E24_5)*gast_1;          gast_2 ~~ c(E8_5_T2, E24_5)*gast_2;     gast_5 ~~ c(E8_5, E24_5)*gast_5         #freed
    musculo_1 ~~ c(E8_6, E24_6)*musculo_1;    musculo_2 ~~ c(E8_6, E24_6)*musculo_2;    musculo_5 ~~ c(E8_6_T5, E24_6)*musculo_5#freed
    cutane_1 ~~ c(E8_7, E24_7)*cutane_1;      cutane_2 ~~ c(E8_7, E24_7)*cutane_2;      cutane_5 ~~ c(E8_7, E24_7)*cutane_5
    bas_act_1 ~~ c(E8_8, E24_8)*bas_act_1;    bas_act_2 ~~ c(E8_8, E24_8)*bas_act_2;    bas_act_5 ~~ c(E8_8, E24_8)*bas_act_5
    comp_act_1 ~~ c(E8_9, E24_9)*comp_act_1;  comp_act_2 ~~ c(E8_9, E24_9)*comp_act_2;  comp_act_5 ~~ c(E8_9, E24_9)*comp_act_5
...
# Step 3: relaxing factload musculo_5 on Phys_5 (SF)----
...
LONG_MODEL_STEP2.12 = '
    ...
    Phys_1  =~ NA*c(L4_8, L4_24)*somatic_1 + c(L5_8, L5_24)*gast_1 + c(L6_8, L6_24)*musculo_1 + c(L7_8, L7_24)*cutane_1 + c(L8_8, L8_24)*vita_1
    Phys_2  =~ NA*c(L4_8, L4_24)*somatic_2 + c(L5_8, L5_24)*gast_2 + c(L6_8, L6_24)*musculo_2 + c(L7_8, L7_24)*cutane_2 + c(L8_8, L8_24)*vita_2
    Phys_5  =~ NA*c(L4_8, L4_24)*somatic_5 + c(L5_8, L5_24)*gast_5 + c(L6_8_T5, L6_24)*musculo_5 + c(L7_8, L7_24)*cutane_5 + c(L8_8, L8_24)*vita_5    #freed
...
# Step 3: relaxing factload comp_act_2 on Func_2 (SF)----
...
LONG_MODEL_STEP2.13 = '
    ...
    Func_1  =~ NA*c(L9_8, L9_24)*bas_act_1 + c(L10_8, L10_24)*comp_act_1 + c(L11_8, L11_24)*social_1
    Func_2  =~ NA*c(L9_8, L9_24)*bas_act_2 + c(L10_8_T2, L10_24)*comp_act_2 + c(L11_8, L11_24)*social_2         #freed
    Func_5  =~ NA*c(L9_8, L9_24)*bas_act_5 + c(L10_8_T5, L10_24)*comp_act_5 + c(L11_8, L11_24)*social_5         #freed
...
# Step 3: relaxing int somatic_2 (SF)----
...
# Step 3: relaxing factload social_5 on psych_5 (MF)----
...
LONG_MODEL_STEP2.15 = '
    ...
    Psych_1 =~ NA*c(L1_8, L1_24)*psych_1 + c(L2_8, L2_24)*social_1 + c(L3_8, L3_24)*vita_1
    Psych_2 =~ NA*c(L1_8, L1_24)*psych_2 + c(L2_8, L2_24)*social_2 + c(L3_8, L3_24)*vita_2
    Psych_5 =~ NA*c(L1_8, L1_24)*psych_5 + c(L2_8, L2_24_T5)*social_5 + c(L3_8, L3_24)*vita_5                   #freed
...
# Step 3: relaxing factload somatic_2 on Phys_2 (MF)----
...
LONG_MODEL_STEP2.16 = '
    ...
    Phys_1  =~ NA*c(L4_8, L4_24)*somatic_1 + c(L5_8, L5_24)*gast_1 + c(L6_8, L6_24)*musculo_1 + c(L7_8, L7_24)*cutane_1 + c(L8_8, L8_24)*vita_1
    Phys_2  =~ NA*c(L4_8, L4_24_T2)*somatic_2 + c(L5_8, L5_24)*gast_2 + c(L6_8, L6_24)*musculo_2 + c(L7_8, L7_24)*cutane_2 + c(L8_8, L8_24)*vita_2    #freed
    Phys_5  =~ NA*c(L4_8, L4_24)*somatic_5 + c(L5_8, L5_24)*gast_5 + c(L6_8_T5, L6_24)*musculo_5 + c(L7_8, L7_24)*cutane_5 + c(L8_8, L8_24)*vita_5    #freed
...
# Step 3: relaxing factload gast_5 on Phys_5 (MF)----
...
LONG_MODEL_STEP2.17 = '
    ...
    Psych_1 =~ NA*c(L1_8, L1_24)*psych_1 + c(L2_8, L2_24)*social_1 + c(L3_8, L3_24)*vita_1
    Psych_2 =~ NA*c(L1_8, L1_24)*psych_2 + c(L2_8, L2_24)*social_2 + c(L3_8, L3_24)*vita_2
    Psych_5 =~ NA*c(L1_8, L1_24)*psych_5 + c(L2_8, L2_24_T5)*social_5 + c(L3_8, L3_24)*vita_5                   #checked

    Phys_1  =~ NA*c(L4_8, L4_24)*somatic_1 + c(L5_8, L5_24)*gast_1 + c(L6_8, L6_24)*musculo_1 + c(L7_8, L7_24)*cutane_1 + c(L8_8, L8_24)*vita_1
    Phys_2  =~ NA*c(L4_8, L4_24_T2)*somatic_2 + c(L5_8, L5_24)*gast_2 + c(L6_8, L6_24)*musculo_2 + c(L7_8, L7_24)*cutane_2 + c(L8_8, L8_24)*vita_2        #checked
    Phys_5  =~ NA*c(L4_8, L4_24)*somatic_5 + c(L5_8, L5_24_T5)*gast_5 + c(L6_8_T5, L6_24)*musculo_5 + c(L7_8, L7_24)*cutane_5 + c(L8_8, L8_24)*vita_5     #checked #checked
    
    Func_1  =~ NA*c(L9_8, L9_24)*bas_act_1 + c(L10_8, L10_24)*comp_act_1 + c(L11_8, L11_24)*social_1
    Func_2  =~ NA*c(L9_8, L9_24)*bas_act_2 + c(L10_8_T2, L10_24)*comp_act_2 + c(L11_8, L11_24)*social_2         #checked
    Func_5  =~ NA*c(L9_8, L9_24)*bas_act_5 + c(L10_8_T5, L10_24)*comp_act_5 + c(L11_8, L11_24)*social_5         #checked

    # INTERCEPTS (Locked)
    psych_1 ~ c(INT8_1, INT24_1)*1;    psych_2 ~ c(INT8_1, INT24_1)*1;      psych_5 ~ c(INT8_1, S24_1_T5)*1     #checked
    social_1 ~ c(INT8_2, INT24_2)*1;   social_2 ~ c(INT8_2, INT24_2)*1;     social_5 ~ c(INT8_2, INT24_2)*1
    vita_1 ~ c(INT8_3, INT24_3)*1;     vita_2 ~ c(INT8_3, INT24_3)*1;       vita_5 ~ c(INT8_3, INT24_3)*1
    somatic_1 ~ c(INT8_4, INT24_4)*1;  somatic_2 ~ c(S8_4_T2, S24_4_T2)*1;  somatic_5 ~ c(INT8_4, INT24_4)*1    #checked #checked
    gast_1 ~ c(INT8_5, INT24_5)*1;     gast_2 ~ c(INT8_5, INT24_5)*1;       gast_5 ~ c(INT8_5, S24_5_T5)*1      #checked
    musculo_1 ~ c(INT8_6, INT24_6)*1;  musculo_2 ~ c(S8_6_T2, S24_6_T2)*1;  musculo_5 ~ c(S8_6_T5, S24_6_T5)*1  #checked #checked #checked #checked
    cutane_1 ~ c(INT8_7, INT24_7)*1;   cutane_2 ~ c(INT8_7, S24_7_T2)*1;    cutane_5 ~ c(INT8_7, INT24_7)*1     #checked
    bas_act_1 ~ c(INT8_8, INT24_8)*1;  bas_act_2 ~ c(INT8_8, INT24_8)*1;    bas_act_5 ~ c(INT8_8, INT24_8)*1
    comp_act_1 ~ c(INT8_9, INT24_9)*1; comp_act_2 ~ c(INT8_9, INT24_9)*1;   comp_act_5 ~ c(INT8_9, INT24_9)*1
    ...
    vita_1 ~~ c(E8_3, E24_3)*vita_1;          vita_2 ~~ c(E8_3, E24_3)*vita_2;          vita_5 ~~ c(E8_3, E24_3)*vita_5
    somatic_1 ~~ c(E8_4, E24_4)*somatic_1;    somatic_2 ~~ c(E8_4, E24_4)*somatic_2;    somatic_5 ~~ c(E8_4, E24_4)*somatic_5
    gast_1 ~~ c(E8_5, E24_5)*gast_1;          gast_2 ~~ c(E8_5_T2, E24_5)*gast_2;       gast_5 ~~ c(E8_5, E24_5)*gast_5             #checked
    musculo_1 ~~ c(E8_6, E24_6)*musculo_1;    musculo_2 ~~ c(E8_6, E24_6)*musculo_2;    musculo_5 ~~ c(E8_6_T5, E24_6)*musculo_5    #checked
    cutane_1 ~~ c(E8_7, E24_7)*cutane_1;      cutane_2 ~~ c(E8_7, E24_7)*cutane_2;      cutane_5 ~~ c(E8_7, E24_7)*cutane_5
    bas_act_1 ~~ c(E8_8, E24_8)*bas_act_1;    bas_act_2 ~~ c(E8_8, E24_8)*bas_act_2;    bas_act_5 ~~ c(E8_8, E24_8)*bas_act_5
    comp_act_1 ~~ c(E8_9, E24_9)*comp_act_1;  comp_act_2 ~~ c(E8_9, E24_9)*comp_act_2;  comp_act_5 ~~ c(E8_9, E24_9)*comp_act_5
    ...
    M_mus_T5_8   := S8_6_T5 + L6_8_T5 * K8_Ph5
    M_cut_T1_8   := INT8_7
    M_cut_T2_8   := INT8_7 + L7_8 * K8_Ph2
    M_cut_T5_8   := INT8_7 + L7_8 * K8_Ph5
    M_bas_T1_8   := INT8_8
    M_bas_T2_8   := INT8_8 + L9_8 * K8_Fu2
    M_bas_T5_8   := INT8_8 + L9_8 * K8_Fu5
    M_com_T1_8   := INT8_9
    M_com_T2_8   := INT8_9 + L10_8_T2 * K8_Fu2
    M_com_T5_8   := INT8_9 + L10_8_T5 * K8_Fu5
    M_vita_T1_8  := INT8_3
    ...
    M_psy_T1_24  := INT24_1
    M_psy_T2_24  := INT24_1 + L1_24 * K24_Ps2
    M_psy_T5_24  := S24_1_T5 + L1_24 * K24_Ps5
    M_som_T1_24  := INT24_4
    M_som_T2_24  := S24_4_T2 + L4_24_T2 * K24_Ph2
    M_som_T5_24  := INT24_4 + L4_24 * K24_Ph5
    M_gas_T1_24  := INT24_5
    M_gas_T2_24  := INT24_5 + L5_24 * K24_Ph2
    M_gas_T5_24  := S24_5_T5 + L5_24_T5 * K24_Ph5
    M_mus_T1_24  := INT24_6
    ...
    M_soc_T5_24  := INT24_2 + (L2_24_T5 * K24_Ps5) + (L11_24 * K24_Fu5)
'
...
# Step 4: true latent shift assessment----
...
LONG_MODEL_STEP4 = '
    ...
    Psych_1 =~ NA*c(L1_8, L1_24)*psych_1 + c(L2_8, L2_24)*social_1 + c(L3_8, L3_24)*vita_1
    Psych_2 =~ NA*c(L1_8, L1_24)*psych_2 + c(L2_8, L2_24)*social_2 + c(L3_8, L3_24)*vita_2
    Psych_5 =~ NA*c(L1_8, L1_24)*psych_5 + c(L2_8, L2_24_T5)*social_5 + c(L3_8, L3_24)*vita_5

    Phys_1  =~ NA*c(L4_8, L4_24)*somatic_1 + c(L5_8, L5_24)*gast_1 + c(L6_8, L6_24)*musculo_1 + c(L7_8, L7_24)*cutane_1 + c(L8_8, L8_24)*vita_1
    Phys_2  =~ NA*c(L4_8, L4_24_T2)*somatic_2 + c(L5_8, L5_24)*gast_2 + c(L6_8, L6_24)*musculo_2 + c(L7_8, L7_24)*cutane_2 + c(L8_8, L8_24)*vita_2      
    Phys_5  =~ NA*c(L4_8, L4_24)*somatic_5 + c(L5_8, L5_24_T5)*gast_5 + c(L6_8_T5, L6_24)*musculo_5 + c(L7_8, L7_24)*cutane_5 + c(L8_8, L8_24)*vita_5     
    
    Func_1  =~ NA*c(L9_8, L9_24)*bas_act_1 + c(L10_8, L10_24)*comp_act_1 + c(L11_8, L11_24)*social_1
    Func_2  =~ NA*c(L9_8, L9_24)*bas_act_2 + c(L10_8_T2, L10_24)*comp_act_2 + c(L11_8, L11_24)*social_2
    Func_5  =~ NA*c(L9_8, L9_24)*bas_act_5 + c(L10_8_T5, L10_24)*comp_act_5 + c(L11_8, L11_24)*social_5
    ...
    vita_1 ~~ c(E8_3, E24_3)*vita_1;          vita_2 ~~ c(E8_3, E24_3)*vita_2;          vita_5 ~~ c(E8_3, E24_3)*vita_5
    somatic_1 ~~ c(E8_4, E24_4)*somatic_1;    somatic_2 ~~ c(E8_4, E24_4)*somatic_2;    somatic_5 ~~ c(E8_4, E24_4)*somatic_5
    gast_1 ~~ c(E8_5, E24_5)*gast_1;          gast_2 ~~ c(E8_5_T2, E24_5)*gast_2;       gast_5 ~~ c(E8_5, E24_5)*gast_5           
    musculo_1 ~~ c(E8_6, E24_6)*musculo_1;    musculo_2 ~~ c(E8_6, E24_6)*musculo_2;    musculo_5 ~~ c(E8_6_T5, E24_6)*musculo_5   
    cutane_1 ~~ c(E8_7, E24_7)*cutane_1;      cutane_2 ~~ c(E8_7, E24_7)*cutane_2;      cutane_5 ~~ c(E8_7, E24_7)*cutane_5
    bas_act_1 ~~ c(E8_8, E24_8)*bas_act_1;    bas_act_2 ~~ c(E8_8, E24_8)*bas_act_2;    bas_act_5 ~~ c(E8_8, E24_8)*bas_act_5
    comp_act_1 ~~ c(E8_9, E24_9)*comp_act_1;  comp_act_2 ~~ c(E8_9, E24_9)*comp_act_2;  comp_act_5 ~~ c(E8_9, E24_9)*comp_act_5
    ...
    # LATENT FACTOR MEANS (Forced to 0)
    Psych_1 ~ c(0,0)*1; Psych_2 ~ c(0,0)*1; Psych_5 ~ c(0,0)*1
    Phys_1  ~ c(0,0)*1; Phys_2  ~ c(0,0)*1; Phys_5  ~ c(0,0)*1
    Func_1  ~ c(0,0)*1; Func_2  ~ c(0,0)*1; Func_5  ~ c(0,0)*1
'

FIT_STEP4 <- cfa(LONG_MODEL_STEP4, 
                    data = BDATA_numeric, 
                    group = "condition",
                    estimator = "MLR", 
                    missing = "fiml",
...
summary(FIT_STEP4, fit.measures = TRUE, standardized = TRUE)

lavTestLRT(FIT_STEP2.17, FIT_STEP4)